...
/*
this is a copy of https://github.com/crossbeam-rs/crossbeam/blob/master/crossbeam-utils/src/cache_padded.rs
I'd like to limit external dependencies and since I need only this file and the licence allows it I copied and pasted it.
*/
